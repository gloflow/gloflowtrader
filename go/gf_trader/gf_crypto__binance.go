...
func binance__init(p_runtime *Runtime) {
	...
	binance__init_symbol("ETHUSD", "etherium_dollar", p_runtime)
	binance__init_symbol("BTCUSD", "bitcoin_dollar",  p_runtime)
}
...
func binance__init_symbol(p_symbol_str string,
	...
	p_runtime.Runtime_sys.Log_fun("FUN_ENTER", "gf_crypto__gemini.binance__init_symbol()")

	//--------------------
	url_str := fmt.Sprintf("wss://stream.binance.com:9443/ws/%s", p_symbol_str)
